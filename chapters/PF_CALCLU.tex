...
Next, neutral hadrons and non-isolated photons are reconstructed.
Finally, any remaining particles are classified as charged hadrons.
The energy is determined for charged hadrons by comparing the cluster energy sum to the track momenta sum.
...
The electromagnetic cluster calibration details are discussed in Chapter~\ref{chapter:ch4}.
