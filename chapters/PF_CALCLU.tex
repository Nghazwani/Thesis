...
\caption[Particles signture in detector]{Particles signture in detector. Figure source~\cite{PF}.}
...
\caption[Different types of seeds]{Different types of seeds. Figure source~\cite{Clustering}.}
\label{fig:seeds}
\end{figure}
