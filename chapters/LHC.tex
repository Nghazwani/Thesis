The LHC is the most powerful particle accelerator in the world. The LHC is a part of the CERN accelerator complex. It sits in a tunnel 100 meters underground at CERN, the European Organization for Nuclear Research, on the border of Switzerland and France near Geneva, as shown in Fig.~\ref{fig:LHC_location}.
The LHC ring is quite large, about 27 km in circumference, and it collides with hadrons, such as protons or heavy ions, by accelerating them in opposite directions and colliding them.
The CERN accelerator complex consists of a succession of machines.
Each machine accelerates a beam of particles to a given energy before injecting the beam into the next machine in the chain.
The LHC is the last element of this chain, designed to collide particles at the center-of-mass energy up to 14 TeV, as shown in Fig.~\ref{fig:acceleration_complex}. 
...
Producing a beam of protons begins with a compressed hydrogen tank supplying gas to the source chamber of Linear Accelerator 4 (Linac4).
...
These proton bunches are recombined at the PSB's exit and further transferred down the CERN injector chain, accelerating the protons to 91.6\% of $c$.
After that, the beam is sent to the Proton Synchrotron (PS), where the increase in energy does not transfer to velocity.
...
The 27 km ring of superconducting magnets keeps protons in the ring while accelerating structures called radio frequency (RF) cavities boost their energy.
