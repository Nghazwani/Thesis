...
\caption[A view of the LHC]{An aerial view of the LHC and the location of its main experiments near the French-Swiss border. Figure source~\cite{LHC_location}.}
...
\caption[A diagram of the CERN accelerator chain]{A schematic diagram of the CERN accelerator chain, including the LINAC, PSB, PS, SPS, and the LHC. The locations of the four main detectors around the LHC are also shown. Figure source~\cite{acceleration_complex}.}
