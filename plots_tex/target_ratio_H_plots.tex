...
\caption[ Response (resolution) vs \pt of the PF H-hadron cluster - traget ratio]{Mean response (resolution) defined by calibrated PF H-hadron clusters using $\chi^{2}$ method (red), DRN modle derivedfrom training samples (green), DRN modle validated on testing samples (blue). (top) barrel, (middle) endcap within tracker, (bottom) endcap outside the tracker. DRN training target is ratio}
\end{figure}
