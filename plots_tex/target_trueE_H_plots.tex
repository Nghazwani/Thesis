...
%\caption{H - endcap within tracker - target trueE}
%\end{figure}
...
\caption{H - (top) barrel, (middle) endcap within tracker, (bottom) endcap outside the tracker - target 'trueE}
\label{fig:H_trueE}
\end{figure}
