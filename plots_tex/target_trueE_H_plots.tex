...
\caption[Energy response (resolution) of the PF H-hadron cluster training traget Etrue]{H - (top) barrel, (middle) endcap within tracker, (bottom) endcap outside the tracker - target: trueE}
\label{fig:H_trueE}
\end{figure}
