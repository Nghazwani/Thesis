...
\caption[Energy response (resolution) of the PF EH-hadron cluster training traget ratio]{EH - (top) barrel, (middle) endcap within tracker, (bottom) endcap outside the tracker - target ratio}
\end{figure}
