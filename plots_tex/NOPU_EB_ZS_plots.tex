...
\caption[$\mu$ ($\sigma_\mathrm{eff}$) vs.\ \pt ($\eta$) of PF ECAL clusters - EB ZS readout NoPU scenario]{Mean response (resolution) defined by raw PF ECAL clusters (red), the calibration derived earlier in Run~3 based on 126X (green), and the new correction from the 2024 simulation sample based on 133X (blue) vs.\ generated photon \pt (top) and $\eta$ (bottom) for the EB region ZS readout NoPU scenario.}
\end{figure}
