...
\caption[Energy response (resolution) of the PF H-hadron cluster training traget log(ratioflip)]{H - (top) barrel, (middle) endcap within tracker, (bottom) endcap outside the tracker - target log(ratioflip)}
\end{figure}
