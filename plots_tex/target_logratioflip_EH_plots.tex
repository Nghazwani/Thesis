...
%\caption{EH - barrel - target log(ratioflip)}
%\end{figure}
...
%\caption{EH - endcap within tracker - target log(ratioflip)}
%\end{figure}
...
%\caption{EH - endcap outside the tracker - target log(ratioflip)}
\caption{EH - (top) barrel, (middle) endcap within tracker, (bottom) endcap outside the tracker - target log(ratioflip)}
\end{figure}
