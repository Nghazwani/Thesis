...
\caption[Energy response (resolution) of the PF EH-hadron cluster training traget log(ratioflip)]{EH - (top) barrel, (middle) endcap within tracker, (bottom) endcap outside the tracker - target log(ratioflip)}
\end{figure}
