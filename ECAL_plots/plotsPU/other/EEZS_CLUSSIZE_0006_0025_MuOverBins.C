void EEZS_CLUSSIZE_0006_0025_MuOverBins()
{
...
//=========  (Sat Feb 10 01:48:53 2024) by ROOT version 6.12/07
   ...
   mu_rawformula_clone__11->SetBinContent(1,0.82);
   mu_rawformula_clone__11->SetBinContent(2,0.882778);
   mu_rawformula_clone__11->SetBinContent(3,0.9158867);
   mu_rawformula_clone__11->SetBinError(1,0.01084907);
   mu_rawformula_clone__11->SetBinError(2,0.01119686);
   mu_rawformula_clone__11->SetBinError(3,0.004701102);
   ...
   mu_rawformula__12->SetBinContent(1,0.82);
   mu_rawformula__12->SetBinContent(2,0.882778);
   mu_rawformula__12->SetBinContent(3,0.9158867);
   mu_rawformula__12->SetBinError(1,0.01084907);
   mu_rawformula__12->SetBinError(2,0.01119686);
   mu_rawformula__12->SetBinError(3,0.004701102);
   ...
   mu_ecor74formula_clone__13->SetBinContent(1,1.03354);
   mu_ecor74formula_clone__13->SetBinContent(2,1.129435);
   mu_ecor74formula_clone__13->SetBinContent(3,1.164975);
   mu_ecor74formula_clone__13->SetBinError(1,0.01386864);
   mu_ecor74formula_clone__13->SetBinError(2,0.00606552);
   mu_ecor74formula_clone__13->SetBinError(3,0.00766937);
   ...
   mu_ecor74formula__14->SetBinContent(1,1.03354);
   mu_ecor74formula__14->SetBinContent(2,1.129435);
   mu_ecor74formula__14->SetBinContent(3,1.164975);
   mu_ecor74formula__14->SetBinError(1,0.01386864);
   mu_ecor74formula__14->SetBinError(2,0.00606552);
   mu_ecor74formula__14->SetBinError(3,0.00766937);
   ...
   mu_ecor91formula_clone__15->SetBinContent(1,1.04337);
   mu_ecor91formula_clone__15->SetBinContent(2,1.071031);
   mu_ecor91formula_clone__15->SetBinContent(3,1.1293);
   mu_ecor91formula_clone__15->SetBinError(1,0.008686804);
   mu_ecor91formula_clone__15->SetBinError(2,0.01286552);
   mu_ecor91formula_clone__15->SetBinError(3,0.007520337);
   ...
   mu_ecor91formula__16->SetBinContent(1,1.04337);
   mu_ecor91formula__16->SetBinContent(2,1.071031);
   mu_ecor91formula__16->SetBinContent(3,1.1293);
   mu_ecor91formula__16->SetBinError(1,0.008686804);
   mu_ecor91formula__16->SetBinError(2,0.01286552);
   mu_ecor91formula__16->SetBinError(3,0.007520337);
