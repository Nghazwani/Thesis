void EEZS_CLUSSIZE_0000_0006_MuOverBins()
{
...
//=========  (Sat Feb 10 01:48:50 2024) by ROOT version 6.12/07
   ...
   mu_rawformula_clone__11->SetBinContent(1,0.78);
   mu_rawformula_clone__11->SetBinContent(2,0.835138);
   mu_rawformula_clone__11->SetBinContent(3,0.9157315);
   mu_rawformula_clone__11->SetBinError(1,0.01263457);
   mu_rawformula_clone__11->SetBinError(2,0.00783667);
   mu_rawformula_clone__11->SetBinError(3,0.0133657);
   ...
   mu_rawformula__12->SetBinContent(1,0.78);
   mu_rawformula__12->SetBinContent(2,0.835138);
   mu_rawformula__12->SetBinContent(3,0.9157315);
   mu_rawformula__12->SetBinError(1,0.01263457);
   mu_rawformula__12->SetBinError(2,0.00783667);
   mu_rawformula__12->SetBinError(3,0.0133657);
   ...
   mu_ecor74formula_clone__13->SetBinContent(1,1.010784);
   mu_ecor74formula_clone__13->SetBinContent(2,1.048447);
   mu_ecor74formula_clone__13->SetBinContent(3,2.870589);
   mu_ecor74formula_clone__13->SetBinError(1,0.01204466);
   mu_ecor74formula_clone__13->SetBinError(2,0.01912066);
   mu_ecor74formula_clone__13->SetBinError(3,1.44295);
   ...
   mu_ecor74formula__14->SetBinContent(1,1.010784);
   mu_ecor74formula__14->SetBinContent(2,1.048447);
   mu_ecor74formula__14->SetBinContent(3,2.870589);
   mu_ecor74formula__14->SetBinError(1,0.01204466);
   mu_ecor74formula__14->SetBinError(2,0.01912066);
   mu_ecor74formula__14->SetBinError(3,1.44295);
   ...
   mu_ecor91formula_clone__15->SetBinContent(1,1.00008);
   mu_ecor91formula_clone__15->SetBinContent(2,1.045166);
   mu_ecor91formula_clone__15->SetBinContent(3,1.066396);
   mu_ecor91formula_clone__15->SetBinError(1,0.09923747);
   mu_ecor91formula_clone__15->SetBinError(2,0.05451176);
   mu_ecor91formula_clone__15->SetBinError(3,0.01217952);
   ...
   mu_ecor91formula__16->SetBinContent(1,1.00008);
   mu_ecor91formula__16->SetBinContent(2,1.045166);
   mu_ecor91formula__16->SetBinContent(3,1.066396);
   mu_ecor91formula__16->SetBinError(1,0.09923747);
   mu_ecor91formula__16->SetBinError(2,0.05451176);
   mu_ecor91formula__16->SetBinError(3,0.01217952);
