void EBFULL_NVTX_0020_0100_EffSigmaOverBins()
{
...
//=========  (Sat Feb 10 01:12:21 2024) by ROOT version 6.12/07
   ...
   sigma_rawformula__81->SetBinContent(1,0.01815268);
   ...
   sigma_ecor74formula__82->SetBinContent(1,0.0126424);
   ...
   sigma_ecor91formula__83->SetBinContent(1,0.01265724);
