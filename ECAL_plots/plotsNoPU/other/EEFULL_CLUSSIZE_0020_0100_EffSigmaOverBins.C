...
//=========  (Sat Feb 10 01:14:10 2024) by ROOT version 6.12/07
   ...
   sigma_rawformula__51->SetBinContent(1,0.07852163);
   sigma_rawformula__51->SetBinContent(2,0.0673757);
   sigma_rawformula__51->SetBinContent(3,0.05677886);
   sigma_rawformula__51->SetBinContent(4,0.0250415);
   sigma_rawformula__51->SetBinContent(5,0.01983033);
   sigma_rawformula__51->SetBinContent(6,0.01558759);
   ...
   sigma_ecor74formula__52->SetBinContent(1,0.07295463);
   sigma_ecor74formula__52->SetBinContent(2,0.06357141);
   sigma_ecor74formula__52->SetBinContent(3,0.04939438);
   sigma_ecor74formula__52->SetBinContent(4,0.02395307);
   sigma_ecor74formula__52->SetBinContent(5,0.01907161);
   sigma_ecor74formula__52->SetBinContent(6,0.01723031);
   ...
   sigma_ecor91formula__53->SetBinContent(1,0.07460429);
   sigma_ecor91formula__53->SetBinContent(2,0.06473996);
   sigma_ecor91formula__53->SetBinContent(3,0.05006325);
   sigma_ecor91formula__53->SetBinContent(4,0.02382535);
   sigma_ecor91formula__53->SetBinContent(5,0.01913152);
   sigma_ecor91formula__53->SetBinContent(6,0.01701423);
