...
//=========  (Sat Feb 10 01:16:01 2024) by ROOT version 6.12/07
   ...
   mu_rawformula_clone__11->SetBinContent(1,0.7400035);
   mu_rawformula_clone__11->SetBinContent(2,0.8727159);
   mu_rawformula_clone__11->SetBinContent(3,1.078288);
   mu_rawformula_clone__11->SetBinError(1,1.414214);
   mu_rawformula_clone__11->SetBinError(2,0.009050689);
   mu_rawformula_clone__11->SetBinError(3,2.135752);
   ...
   mu_rawformula__12->SetBinContent(1,0.7400035);
   mu_rawformula__12->SetBinContent(2,0.8727159);
   mu_rawformula__12->SetBinContent(3,1.078288);
   mu_rawformula__12->SetBinError(1,1.414214);
   mu_rawformula__12->SetBinError(2,0.009050689);
   mu_rawformula__12->SetBinError(3,2.135752);
   ...
   mu_ecor74formula_clone__13->SetBinContent(1,0.9345115);
   mu_ecor74formula_clone__13->SetBinContent(2,1.093775);
   mu_ecor74formula_clone__13->SetBinContent(3,1.357852);
   mu_ecor74formula_clone__13->SetBinError(1,0.009365325);
   mu_ecor74formula_clone__13->SetBinError(2,0.0124106);
   mu_ecor74formula_clone__13->SetBinError(3,2.285675);
   ...
   mu_ecor74formula__14->SetBinContent(1,0.9345115);
   mu_ecor74formula__14->SetBinContent(2,1.093775);
   mu_ecor74formula__14->SetBinContent(3,1.357852);
   mu_ecor74formula__14->SetBinError(1,0.009365325);
   mu_ecor74formula__14->SetBinError(2,0.0124106);
   mu_ecor74formula__14->SetBinError(3,2.285675);
   ...
   mu_ecor91formula_clone__15->SetBinContent(1,0.9131255);
   mu_ecor91formula_clone__15->SetBinContent(2,1.06833);
   mu_ecor91formula_clone__15->SetBinContent(3,1.280187);
   mu_ecor91formula_clone__15->SetBinError(1,0.01445584);
   mu_ecor91formula_clone__15->SetBinError(2,0.00749903);
   mu_ecor91formula_clone__15->SetBinError(3,2.266093);
   ...
   mu_ecor91formula__16->SetBinContent(1,0.9131255);
   mu_ecor91formula__16->SetBinContent(2,1.06833);
   mu_ecor91formula__16->SetBinContent(3,1.280187);
   mu_ecor91formula__16->SetBinError(1,0.01445584);
   mu_ecor91formula__16->SetBinError(2,0.00749903);
   mu_ecor91formula__16->SetBinError(3,2.266093);
