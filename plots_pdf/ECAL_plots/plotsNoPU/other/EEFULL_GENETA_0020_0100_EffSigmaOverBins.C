...
//=========  (Sat Feb 10 01:14:18 2024) by ROOT version 6.12/07
   ...
   sigma_rawformula__51->SetBinContent(1,0.04870063);
   sigma_rawformula__51->SetBinContent(2,0.02271745);
   sigma_rawformula__51->SetBinContent(3,0.02373874);
   sigma_rawformula__51->SetBinContent(4,0.02711738);
   sigma_rawformula__51->SetBinContent(5,0.0304622);
   sigma_rawformula__51->SetBinContent(6,0.04028379);
   sigma_rawformula__51->SetBinContent(7,0.07725608);
   ...
   sigma_ecor74formula__52->SetBinContent(1,0.04082199);
   sigma_ecor74formula__52->SetBinContent(2,0.02076874);
   sigma_ecor74formula__52->SetBinContent(3,0.02159924);
   sigma_ecor74formula__52->SetBinContent(4,0.02396742);
   sigma_ecor74formula__52->SetBinContent(5,0.02766814);
   sigma_ecor74formula__52->SetBinContent(6,0.03570772);
   sigma_ecor74formula__52->SetBinContent(7,0.06438842);
   ...
   sigma_ecor91formula__53->SetBinContent(1,0.04014868);
   sigma_ecor91formula__53->SetBinContent(2,0.02055517);
   sigma_ecor91formula__53->SetBinContent(3,0.02144727);
   sigma_ecor91formula__53->SetBinContent(4,0.02459);
   sigma_ecor91formula__53->SetBinContent(5,0.02732988);
   sigma_ecor91formula__53->SetBinContent(6,0.03474107);
   sigma_ecor91formula__53->SetBinContent(7,0.06503619);
