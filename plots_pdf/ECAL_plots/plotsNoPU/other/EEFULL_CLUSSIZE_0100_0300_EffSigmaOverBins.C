...
//=========  (Sat Feb 10 01:14:12 2024) by ROOT version 6.12/07
   ...
   sigma_rawformula__51->SetBinContent(1,0.09962534);
   sigma_rawformula__51->SetBinContent(2,0.08567814);
   sigma_rawformula__51->SetBinContent(3,0.06661838);
   sigma_rawformula__51->SetBinContent(4,0.05129431);
   sigma_rawformula__51->SetBinContent(5,0.02735744);
   sigma_rawformula__51->SetBinContent(6,0.02142953);
   sigma_rawformula__51->SetBinContent(7,0.01889138);
   ...
   sigma_ecor74formula__52->SetBinContent(1,0.0841895);
   sigma_ecor74formula__52->SetBinContent(2,0.08112277);
   sigma_ecor74formula__52->SetBinContent(3,0.05597701);
   sigma_ecor74formula__52->SetBinContent(4,0.04628741);
   sigma_ecor74formula__52->SetBinContent(5,0.02611933);
   sigma_ecor74formula__52->SetBinContent(6,0.02095771);
   sigma_ecor74formula__52->SetBinContent(7,0.01821336);
   ...
   sigma_ecor91formula__53->SetBinContent(1,0.09050513);
   sigma_ecor91formula__53->SetBinContent(2,0.08359449);
   sigma_ecor91formula__53->SetBinContent(3,0.05603643);
   sigma_ecor91formula__53->SetBinContent(4,0.04611622);
   sigma_ecor91formula__53->SetBinContent(5,0.02608003);
   sigma_ecor91formula__53->SetBinContent(6,0.02102383);
   sigma_ecor91formula__53->SetBinContent(7,0.01835417);
