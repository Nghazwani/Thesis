void EEFULL_GENETA_0100_0300_EffSigmaOverBins()
{
...
//=========  (Sat Feb 10 01:14:20 2024) by ROOT version 6.12/07
   ...
   sigma_rawformula__51->SetBinContent(1,0.05175448);
   sigma_rawformula__51->SetBinContent(2,0.02270892);
   sigma_rawformula__51->SetBinContent(3,0.02332315);
   sigma_rawformula__51->SetBinContent(4,0.02645306);
   sigma_rawformula__51->SetBinContent(5,0.02799861);
   sigma_rawformula__51->SetBinContent(6,0.03868464);
   sigma_rawformula__51->SetBinContent(7,0.07061245);
   ...
   sigma_ecor74formula__52->SetBinContent(1,0.04312987);
   sigma_ecor74formula__52->SetBinContent(2,0.02180814);
   sigma_ecor74formula__52->SetBinContent(3,0.02291377);
   sigma_ecor74formula__52->SetBinContent(4,0.02663589);
   sigma_ecor74formula__52->SetBinContent(5,0.0276788);
   sigma_ecor74formula__52->SetBinContent(6,0.03800402);
   sigma_ecor74formula__52->SetBinContent(7,0.05725275);
   ...
   sigma_ecor91formula__53->SetBinContent(1,0.04238943);
   sigma_ecor91formula__53->SetBinContent(2,0.02185022);
   sigma_ecor91formula__53->SetBinContent(3,0.02294549);
   sigma_ecor91formula__53->SetBinContent(4,0.0264526);
   sigma_ecor91formula__53->SetBinContent(5,0.0275125);
   sigma_ecor91formula__53->SetBinContent(6,0.03782498);
   sigma_ecor91formula__53->SetBinContent(7,0.05697756);
