...
//=========  (Sat Feb 10 01:11:58 2024) by ROOT version 6.12/07
   ...
   sigma_rawformula__51->SetBinContent(3,0.08208589);
   sigma_rawformula__51->SetBinContent(4,0.06404009);
   sigma_rawformula__51->SetBinContent(5,0.0120705);
   sigma_rawformula__51->SetBinContent(6,0.01024438);
   sigma_rawformula__51->SetBinContent(7,0.008582661);
   ...
   sigma_ecor74formula__52->SetBinContent(3,0.08986094);
   sigma_ecor74formula__52->SetBinContent(4,0.05709413);
   sigma_ecor74formula__52->SetBinContent(5,0.01173975);
   sigma_ecor74formula__52->SetBinContent(6,0.00980358);
   sigma_ecor74formula__52->SetBinContent(7,0.007971654);
   ...
   sigma_ecor91formula__53->SetBinContent(3,0.09016841);
   sigma_ecor91formula__53->SetBinContent(4,0.05664555);
   sigma_ecor91formula__53->SetBinContent(5,0.01169746);
   sigma_ecor91formula__53->SetBinContent(6,0.00980959);
   sigma_ecor91formula__53->SetBinContent(7,0.007990131);
