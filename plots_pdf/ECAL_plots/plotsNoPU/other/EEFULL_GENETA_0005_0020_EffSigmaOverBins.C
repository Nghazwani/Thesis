void EEFULL_GENETA_0005_0020_EffSigmaOverBins()
{
...
//=========  (Sat Feb 10 01:14:16 2024) by ROOT version 6.12/07
   ...
   sigma_rawformula__51->SetBinContent(1,0.05673356);
   sigma_rawformula__51->SetBinContent(2,0.03842159);
   sigma_rawformula__51->SetBinContent(3,0.03997865);
   sigma_rawformula__51->SetBinContent(4,0.04568958);
   sigma_rawformula__51->SetBinContent(5,0.04935967);
   sigma_rawformula__51->SetBinContent(6,0.06309557);
   sigma_rawformula__51->SetBinContent(7,0.0979443);
   ...
   sigma_ecor74formula__52->SetBinContent(1,0.04904665);
   sigma_ecor74formula__52->SetBinContent(2,0.0362661);
   sigma_ecor74formula__52->SetBinContent(3,0.03637208);
   sigma_ecor74formula__52->SetBinContent(4,0.03476074);
   sigma_ecor74formula__52->SetBinContent(5,0.03947301);
   sigma_ecor74formula__52->SetBinContent(6,0.0556275);
   sigma_ecor74formula__52->SetBinContent(7,0.08795086);
   ...
   sigma_ecor91formula__53->SetBinContent(1,0.04987765);
   sigma_ecor91formula__53->SetBinContent(2,0.03317342);
   sigma_ecor91formula__53->SetBinContent(3,0.03506337);
   sigma_ecor91formula__53->SetBinContent(4,0.03998294);
   sigma_ecor91formula__53->SetBinContent(5,0.0453753);
   sigma_ecor91formula__53->SetBinContent(6,0.05741041);
   sigma_ecor91formula__53->SetBinContent(7,0.08687434);
