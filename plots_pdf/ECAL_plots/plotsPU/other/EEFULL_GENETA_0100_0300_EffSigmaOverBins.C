...
//=========  (Sat Feb 10 01:47:21 2024) by ROOT version 6.12/07
   ...
   sigma_rawformula__51->SetBinContent(1,0.05058851);
   sigma_rawformula__51->SetBinContent(2,0.02318558);
   sigma_rawformula__51->SetBinContent(3,0.02317801);
   sigma_rawformula__51->SetBinContent(4,0.02567614);
   sigma_rawformula__51->SetBinContent(5,0.02848428);
   sigma_rawformula__51->SetBinContent(6,0.04025698);
   sigma_rawformula__51->SetBinContent(7,0.07012561);
   ...
   sigma_ecor74formula__52->SetBinContent(1,0.04097899);
   sigma_ecor74formula__52->SetBinContent(2,0.02252836);
   sigma_ecor74formula__52->SetBinContent(3,0.02284116);
   sigma_ecor74formula__52->SetBinContent(4,0.02568042);
   sigma_ecor74formula__52->SetBinContent(5,0.02881486);
   sigma_ecor74formula__52->SetBinContent(6,0.0387254);
   sigma_ecor74formula__52->SetBinContent(7,0.05826936);
   ...
   sigma_ecor91formula__53->SetBinContent(1,0.040632);
   sigma_ecor91formula__53->SetBinContent(2,0.02252655);
   sigma_ecor91formula__53->SetBinContent(3,0.0227356);
   sigma_ecor91formula__53->SetBinContent(4,0.02554687);
   sigma_ecor91formula__53->SetBinContent(5,0.02915638);
   sigma_ecor91formula__53->SetBinContent(6,0.03914467);
   sigma_ecor91formula__53->SetBinContent(7,0.05750096);
