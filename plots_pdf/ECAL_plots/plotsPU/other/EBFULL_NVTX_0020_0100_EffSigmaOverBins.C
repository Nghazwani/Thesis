...
//=========  (Sat Feb 10 01:45:16 2024) by ROOT version 6.12/07
   ...
   sigma_rawformula__81->SetBinContent(1,0.01963653);
   sigma_rawformula__81->SetBinContent(2,0.01974052);
   sigma_rawformula__81->SetBinContent(3,0.02005662);
   sigma_rawformula__81->SetBinContent(4,0.02020884);
   sigma_rawformula__81->SetBinContent(5,0.02049862);
   sigma_rawformula__81->SetBinContent(6,0.0198213);
   sigma_rawformula__81->SetBinContent(7,0.0201215);
   sigma_rawformula__81->SetBinContent(8,0.0200166);
   sigma_rawformula__81->SetBinContent(9,0.02043853);
   sigma_rawformula__81->SetBinContent(10,0.02044333);
   sigma_rawformula__81->SetBinContent(11,0.02046412);
   sigma_rawformula__81->SetBinContent(12,0.02019108);
   ...
   sigma_ecor74formula__82->SetBinContent(1,0.01321601);
   sigma_ecor74formula__82->SetBinContent(2,0.01352515);
   sigma_ecor74formula__82->SetBinContent(3,0.01368124);
   sigma_ecor74formula__82->SetBinContent(4,0.01385984);
   sigma_ecor74formula__82->SetBinContent(5,0.01407537);
   sigma_ecor74formula__82->SetBinContent(6,0.01397109);
   sigma_ecor74formula__82->SetBinContent(7,0.01438149);
   sigma_ecor74formula__82->SetBinContent(8,0.0143108);
   sigma_ecor74formula__82->SetBinContent(9,0.01464876);
   sigma_ecor74formula__82->SetBinContent(10,0.0147439);
   sigma_ecor74formula__82->SetBinContent(11,0.01474103);
   sigma_ecor74formula__82->SetBinContent(12,0.01478743);
   ...
   sigma_ecor91formula__83->SetBinContent(1,0.01327935);
   sigma_ecor91formula__83->SetBinContent(2,0.01352085);
   sigma_ecor91formula__83->SetBinContent(3,0.01372984);
   sigma_ecor91formula__83->SetBinContent(4,0.01390118);
   sigma_ecor91formula__83->SetBinContent(5,0.01402885);
   sigma_ecor91formula__83->SetBinContent(6,0.01398398);
   sigma_ecor91formula__83->SetBinContent(7,0.0143994);
   sigma_ecor91formula__83->SetBinContent(8,0.0142459);
   sigma_ecor91formula__83->SetBinContent(9,0.01466864);
   sigma_ecor91formula__83->SetBinContent(10,0.01481476);
   sigma_ecor91formula__83->SetBinContent(11,0.01483106);
   sigma_ecor91formula__83->SetBinContent(12,0.01474138);
