void EEFULL_CLUSSIZE_0020_0100_EffSigmaOverBins()
{
...
//=========  (Sat Feb 10 01:47:11 2024) by ROOT version 6.12/07
   ...
   sigma_rawformula__51->SetBinContent(1,0.08253551);
   sigma_rawformula__51->SetBinContent(2,0.07112112);
   sigma_rawformula__51->SetBinContent(3,0.05810627);
   sigma_rawformula__51->SetBinContent(4,0.0254366);
   sigma_rawformula__51->SetBinContent(5,0.02049343);
   sigma_rawformula__51->SetBinContent(6,0.007893809);
   ...
   sigma_ecor74formula__52->SetBinContent(1,0.07674744);
   sigma_ecor74formula__52->SetBinContent(2,0.06713852);
   sigma_ecor74formula__52->SetBinContent(3,0.05335031);
   sigma_ecor74formula__52->SetBinContent(4,0.02458744);
   sigma_ecor74formula__52->SetBinContent(5,0.0202268);
   sigma_ecor74formula__52->SetBinContent(6,0.009736665);
   ...
   sigma_ecor91formula__53->SetBinContent(1,0.07807907);
   sigma_ecor91formula__53->SetBinContent(2,0.06789245);
   sigma_ecor91formula__53->SetBinContent(3,0.05405924);
   sigma_ecor91formula__53->SetBinContent(4,0.02449974);
   sigma_ecor91formula__53->SetBinContent(5,0.02014182);
   sigma_ecor91formula__53->SetBinContent(6,0.00873623);
