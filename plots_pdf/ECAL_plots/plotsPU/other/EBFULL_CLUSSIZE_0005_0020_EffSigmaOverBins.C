void EBFULL_CLUSSIZE_0005_0020_EffSigmaOverBins()
{
...
//=========  (Sat Feb 10 01:44:48 2024) by ROOT version 6.12/07
   ...
   sigma_rawformula__51->SetBinContent(1,0.02925683);
   sigma_rawformula__51->SetBinContent(2,0.02546483);
   sigma_rawformula__51->SetBinContent(3,0.03248044);
   sigma_rawformula__51->SetBinContent(4,0.03068786);
   ...
   sigma_ecor74formula__52->SetBinContent(1,0.02809698);
   sigma_ecor74formula__52->SetBinContent(2,0.02569537);
   sigma_ecor74formula__52->SetBinContent(3,0.02982026);
   sigma_ecor74formula__52->SetBinContent(4,0.03539512);
   ...
   sigma_ecor91formula__53->SetBinContent(1,0.02854346);
   sigma_ecor91formula__53->SetBinContent(2,0.02715758);
   sigma_ecor91formula__53->SetBinContent(3,0.0293634);
   sigma_ecor91formula__53->SetBinContent(4,0.03441798);
