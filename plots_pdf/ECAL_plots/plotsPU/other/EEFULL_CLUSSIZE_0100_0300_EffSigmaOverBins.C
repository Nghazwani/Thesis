void EEFULL_CLUSSIZE_0100_0300_EffSigmaOverBins()
{
...
//=========  (Sat Feb 10 01:47:13 2024) by ROOT version 6.12/07
   ...
   sigma_rawformula__51->SetBinContent(1,0.09335601);
   sigma_rawformula__51->SetBinContent(2,0.08377854);
   sigma_rawformula__51->SetBinContent(3,0.06709138);
   sigma_rawformula__51->SetBinContent(4,0.05219108);
   sigma_rawformula__51->SetBinContent(5,0.02682352);
   sigma_rawformula__51->SetBinContent(6,0.02121519);
   sigma_rawformula__51->SetBinContent(7,0.01851315);
   ...
   sigma_ecor74formula__52->SetBinContent(1,0.08874038);
   sigma_ecor74formula__52->SetBinContent(2,0.08059324);
   sigma_ecor74formula__52->SetBinContent(3,0.05759823);
   sigma_ecor74formula__52->SetBinContent(4,0.04774189);
   sigma_ecor74formula__52->SetBinContent(5,0.02594341);
   sigma_ecor74formula__52->SetBinContent(6,0.02093189);
   sigma_ecor74formula__52->SetBinContent(7,0.01835897);
   ...
   sigma_ecor91formula__53->SetBinContent(1,0.09142742);
   sigma_ecor91formula__53->SetBinContent(2,0.08297152);
   sigma_ecor91formula__53->SetBinContent(3,0.05730659);
   sigma_ecor91formula__53->SetBinContent(4,0.04721005);
   sigma_ecor91formula__53->SetBinContent(5,0.02580861);
   sigma_ecor91formula__53->SetBinContent(6,0.02082826);
   sigma_ecor91formula__53->SetBinContent(7,0.01819532);
