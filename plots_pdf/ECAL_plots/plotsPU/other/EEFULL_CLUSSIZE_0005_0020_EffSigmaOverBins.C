...
//=========  (Sat Feb 10 01:47:09 2024) by ROOT version 6.12/07
   ...
   sigma_rawformula__51->SetBinContent(1,0.0749011);
   sigma_rawformula__51->SetBinContent(2,0.05644466);
   sigma_rawformula__51->SetBinContent(3,0.03834277);
   sigma_rawformula__51->SetBinContent(4,0.04001647);
   ...
   sigma_ecor74formula__52->SetBinContent(1,0.07137981);
   sigma_ecor74formula__52->SetBinContent(2,0.05615045);
   sigma_ecor74formula__52->SetBinContent(3,0.04003493);
   sigma_ecor74formula__52->SetBinContent(4,0.03749317);
   ...
   sigma_ecor91formula__53->SetBinContent(1,0.07176038);
   sigma_ecor91formula__53->SetBinContent(2,0.05597112);
   sigma_ecor91formula__53->SetBinContent(3,0.03725276);
   sigma_ecor91formula__53->SetBinContent(4,0.04025026);
