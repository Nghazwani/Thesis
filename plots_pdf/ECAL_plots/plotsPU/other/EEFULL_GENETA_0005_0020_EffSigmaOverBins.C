...
//=========  (Sat Feb 10 01:47:18 2024) by ROOT version 6.12/07
   ...
   sigma_rawformula__51->SetBinContent(1,0.05877306);
   sigma_rawformula__51->SetBinContent(2,0.0426806);
   sigma_rawformula__51->SetBinContent(3,0.04455198);
   sigma_rawformula__51->SetBinContent(4,0.0502644);
   sigma_rawformula__51->SetBinContent(5,0.05570941);
   sigma_rawformula__51->SetBinContent(6,0.07557795);
   sigma_rawformula__51->SetBinContent(7,0.1059127);
   ...
   sigma_ecor74formula__52->SetBinContent(1,0.0511973);
   sigma_ecor74formula__52->SetBinContent(2,0.03933425);
   sigma_ecor74formula__52->SetBinContent(3,0.03880968);
   sigma_ecor74formula__52->SetBinContent(4,0.04110836);
   sigma_ecor74formula__52->SetBinContent(5,0.04635102);
   sigma_ecor74formula__52->SetBinContent(6,0.0648323);
   sigma_ecor74formula__52->SetBinContent(7,0.09541277);
   ...
   sigma_ecor91formula__53->SetBinContent(1,0.05001194);
   sigma_ecor91formula__53->SetBinContent(2,0.03701131);
   sigma_ecor91formula__53->SetBinContent(3,0.03842633);
   sigma_ecor91formula__53->SetBinContent(4,0.04500765);
   sigma_ecor91formula__53->SetBinContent(5,0.04994082);
   sigma_ecor91formula__53->SetBinContent(6,0.0676232);
   sigma_ecor91formula__53->SetBinContent(7,0.09675839);
