...
//=========  (Sat Feb 10 01:44:49 2024) by ROOT version 6.12/07
   ...
   sigma_rawformula__51->SetBinContent(2,0.07561214);
   sigma_rawformula__51->SetBinContent(3,0.02019029);
   sigma_rawformula__51->SetBinContent(4,0.01553878);
   sigma_rawformula__51->SetBinContent(5,0.01096158);
   sigma_rawformula__51->SetBinContent(6,0.01045487);
   ...
   sigma_ecor74formula__52->SetBinContent(2,0.07833875);
   sigma_ecor74formula__52->SetBinContent(3,0.01945319);
   sigma_ecor74formula__52->SetBinContent(4,0.01355693);
   sigma_ecor74formula__52->SetBinContent(5,0.01073212);
   sigma_ecor74formula__52->SetBinContent(6,0.01049807);
   ...
   sigma_ecor91formula__53->SetBinContent(2,0.170344);
   sigma_ecor91formula__53->SetBinContent(3,0.01941708);
   sigma_ecor91formula__53->SetBinContent(4,0.01354293);
   sigma_ecor91formula__53->SetBinContent(5,0.0107359);
   sigma_ecor91formula__53->SetBinContent(6,0.009783031);
