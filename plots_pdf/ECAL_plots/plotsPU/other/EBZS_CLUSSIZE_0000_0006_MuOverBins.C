...
//=========  (Sat Feb 10 01:48:17 2024) by ROOT version 6.12/07
   ...
   mu_rawformula_clone__11->SetBinContent(1,0.8740388);
   mu_rawformula_clone__11->SetBinContent(2,0.8200039);
   mu_rawformula_clone__11->SetBinContent(3,0.908842);
   mu_rawformula_clone__11->SetBinError(1,35.54326);
   mu_rawformula_clone__11->SetBinError(2,1.414214);
   mu_rawformula_clone__11->SetBinError(3,0.008573941);
   ...
   mu_rawformula__12->SetBinContent(1,0.8740388);
   mu_rawformula__12->SetBinContent(2,0.8200039);
   mu_rawformula__12->SetBinContent(3,0.908842);
   mu_rawformula__12->SetBinError(1,35.54326);
   mu_rawformula__12->SetBinError(2,1.414214);
   mu_rawformula__12->SetBinError(3,0.008573941);
   ...
   mu_ecor74formula_clone__13->SetBinContent(1,0.9107157);
   mu_ecor74formula_clone__13->SetBinContent(2,1.074547);
   mu_ecor74formula_clone__13->SetBinContent(3,0.98);
   mu_ecor74formula_clone__13->SetBinError(1,0.1129571);
   mu_ecor74formula_clone__13->SetBinError(2,31.04177);
   mu_ecor74formula_clone__13->SetBinError(3,0.01442567);
   ...
   mu_ecor74formula__14->SetBinContent(1,0.9107157);
   mu_ecor74formula__14->SetBinContent(2,1.074547);
   mu_ecor74formula__14->SetBinContent(3,0.98);
   mu_ecor74formula__14->SetBinError(1,0.1129571);
   mu_ecor74formula__14->SetBinError(2,31.04177);
   mu_ecor74formula__14->SetBinError(3,0.01442567);
   ...
   mu_ecor91formula_clone__15->SetBinContent(1,1.074335);
   mu_ecor91formula_clone__15->SetBinContent(2,1.117259);
   mu_ecor91formula_clone__15->SetBinContent(3,1.040022);
   mu_ecor91formula_clone__15->SetBinError(1,33.74521);
   mu_ecor91formula_clone__15->SetBinError(2,2.090481);
   mu_ecor91formula_clone__15->SetBinError(3,0.08073694);
   ...
   mu_ecor91formula__16->SetBinContent(1,1.074335);
   mu_ecor91formula__16->SetBinContent(2,1.117259);
   mu_ecor91formula__16->SetBinContent(3,1.040022);
   mu_ecor91formula__16->SetBinError(1,33.74521);
   mu_ecor91formula__16->SetBinError(2,2.090481);
   mu_ecor91formula__16->SetBinError(3,0.08073694);
