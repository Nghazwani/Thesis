...
%\input{chapters/ch1}
\label{chapter:ch1}                                                                                                  
\input{chapters/chapters_clean_version/ch_SM_draft.tex} 
%=====================================    
...
%\input{chapters/ch3}
\label{chapter:ch2}
\input{chapters/chapters_clean_version/ch_LHC_draft.tex}
...
%\input{chapters/ch2}
\label{chapter:ch3}
%\input{chapters/chapters_clean_version/ch_PF_draft.tex}
\input{chapters/chapters_clean_version/ch_PF_draft_v2.tex}
%=====================================
\chapter{Electromagnetic Cluster Calibration Using Boosted Decision Tree}
%\label{chapter:ch3}
%\input{chapters/ch3}
\label{chapter:ch4}
\input{chapters/chapters_clean_version/ch_ECALCAL_draft.tex}
%=====================================
\chapter{Hadronic Cluster Calibration Using Graph Neural Network}
%\label{chapter:ch4}
%\input{chapters/ch4}
\label{chapter:ch5}
\input{chapters/chapters_clean_version/ch_HCALCAL_draft.tex}
%=====================================
